...
upvalueScriptContext:SetCallback(function()
    ...
    local generatedScript = [[-- Generated by Hydroxide's Upvalue Scanner: https://github.com/LiamBogur/Hydroxide

local aux = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/LiamBogur/Hydroxide/revision/ohaux.lua"))()
